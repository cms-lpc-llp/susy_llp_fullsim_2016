if __name__ == '__main__':
    ...
    config.JobType.psetName = '/afs/cern.ch/user/j/jmao/work/public/releases/cms-llp/CMSSW_8_0_21/src/crab_scripts/Fullsim_step1_cfg.py'
	...
	for mchi in mchi_list:
		...
		name = mode+"_mchi{}_pl{}_ev{}".format(mchi,pl,ev)
	        ...
	        config.Data.inputDataset = '/n3n2-n1-hbb-hbb_mh200_pl1000_ev100000/jmao-crab_CMSSW_7_1_24_n3n2-n1-hbb-hbb_mchi200_pl1000_ev100000_GENSIM_CaltechT2-6560f7fbb700012df132abdf3e2c4b11/USER'
