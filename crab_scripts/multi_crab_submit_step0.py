if __name__ == '__main__':
    ...
    pset_dir = "/afs/cern.ch/user/j/jmao/work/public/releases/cms-llp/CMSSW_7_1_24/src/"
	...
	for mchi in mchi_list:
		...
		spec = mode+"_mh{}_pl{}_ev{}".format(mchi,pl,ev)
    		...
    		config.General.requestName = 'CMSSW_7_1_24_'+mode+"_mchi{}_pl{}_ev{}".format(mchi,pl,ev)+'_GENSIM_CaltechT2'
		...
		if "x1n2" in mode:
			config.Data.outLFNDirBase = '/store/group/phys_exotica/jmao/aodsim/RunIISummer16/GENSIM/MSSM-2d-prod/'
